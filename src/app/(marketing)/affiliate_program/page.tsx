...
export default function AffiliateProgramPage() {
  const body = `
    <div class="bodycontainer2 padding">
        <br><br>
        <div class="title_container"><h4>Our Affiliate Program</h4><span class="decor_default"></span></div>
        ...
        <blockquote>Every deposit of your referral will bring you a reward in the amount of 7% and $2 for Referral Registration.</blockquote>
...
`;
  return (
    <InfoPage
      titleHtml={`AFFILIATE <span class="text-default">PROGRAM</span>`}
      crumbHtml={`<a href="/">HOME</a> / AFFILIATE PROGRAM`}
      bodyHtml={body}
    />
  );
}
